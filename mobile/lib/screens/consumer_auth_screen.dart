...
import 'consumer_transactions_screen.dart';
import '../theme/transitions.dart';

class ConsumerAuthScreen extends StatefulWidget {
  const ConsumerAuthScreen({super.key});

  @override
  State<ConsumerAuthScreen> createState() => _ConsumerAuthScreenState();
}

class _ConsumerAuthScreenState extends State<ConsumerAuthScreen> {
    ...
    try {
      ...
      if (mounted) {
        Navigator.of(context).push(
          fadeRoute(const ConsumerTransactionsScreen()),
        );
      }
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  const Expanded(child: StepBar(total: 2, current: 1)),
                ],
              ),
            ),
